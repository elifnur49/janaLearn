...
public class C02_TypeCasting {
	...
	/*
        ...
        //String basarı=basarılı; -> dogal uyum olmayan variable'larda casting yapılamaz CTE
        ...
        System.out.println("ascii degeri istedigin karakteri giriniz");
         char ch=sc.nextLine().charAt(0);
         int chasciidegeri=ch;
        System.out.println("chasciidegeri:"+chasciidegeri);
